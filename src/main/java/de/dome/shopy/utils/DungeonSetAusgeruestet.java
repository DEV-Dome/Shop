            ...
            if(item != null && item.hasItemMeta() && item.getItemMeta().hasLore()) {
                ...
                if (baseItem.getItemVerzauberungenSet() != null) {
                    ...
                    if(inv.getHelmet() != null && inv.getHelmet().getType().getEquipmentSlot() != item.getType().getEquipmentSlot()){
                        ...
                        if (helmItem.getItemVerzauberungenSet() != null && helmItem.getItemVerzauberungenSet().getId() == baseSet.getId())setCount++;
                    }
                    ...
                    if(inv.getChestplate() != null && inv.getChestplate().getType().getEquipmentSlot() != item.getType().getEquipmentSlot()){
                        ...
                        if (ruestungsItem.getItemVerzauberungenSet() != null && ruestungsItem.getItemVerzauberungenSet().getId() == baseSet.getId())setCount++;
                    }
                    ...
                    if(inv.getLeggings() != null && inv.getLeggings().getType().getEquipmentSlot() != item.getType().getEquipmentSlot()){
                        ...
                        if (hosenItem.getItemVerzauberungenSet() != null && hosenItem.getItemVerzauberungenSet().getId() == baseSet.getId()) setCount++;
                    }
                    ...
                    if(inv.getBoots() != null && inv.getBoots().getType().getEquipmentSlot() != item.getType().getEquipmentSlot()){
                        ...
                        if (schuheItem.getItemVerzauberungenSet() != null && schuheItem.getItemVerzauberungenSet().getId() == baseSet.getId()) setCount++;
                    }


                    if(setCount >= 4){
                        if(spielerDungeon.getDungeonSetAusgeruestet().containsKey(baseSet.getName())) spielerDungeon.getDungeonSetAusgeruestet().remove(baseSet.getName());
