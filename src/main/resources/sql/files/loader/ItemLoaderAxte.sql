    INSERT INTO item (item_kategorie, icon, name, beschreibung, item_seltenheit, reinfolge) VALUES ('1', 'WOODEN_AXE', 'Anfänger Axt I', 'Diese Axt wurde von einem Schreinerlehrling \n hergestellt und dient nun dem Zweck, \n das Schreinerhandwerk zu erlernen.', 1, 1);
        ...
        INSERT INTO item_werte (item, schlussel, inhalt) VALUES (1, "max_angriffsgeschwindigkeit", 0.3);
    INSERT INTO item (item_kategorie, icon, name, beschreibung, item_seltenheit, reinfolge) VALUES ('1', 'WOODEN_AXE', 'Axt von Roland', 'Man munkelt diese Art von Äxten, gehört nicht\n nur einen Roland. Nein er soll diese \n erfunden haben.', 2, 2);
        ...
        INSERT INTO item_werte (item, schlussel, inhalt) VALUES (2, "min_schaden", 5);
        INSERT INTO item_werte (item, schlussel, inhalt) VALUES (2, "max_schaden", 7.5);

        INSERT INTO item_werte (item, schlussel, inhalt) VALUES (2, "min_angriffsgeschwindigkeit", 0.2);
        INSERT INTO item_werte (item, schlussel, inhalt) VALUES (2, "max_angriffsgeschwindigkeit", 0.35);
    ...
    INSERT INTO item (item_kategorie, icon, name, beschreibung, item_seltenheit, reinfolge) VALUES ('1', 'WOODEN_AXE', 'Spielzeug Axt', 'Kinder nutzen diese Axt oft zum Spielen.\n Weil Sie so harmlos ist, geben Eltern \n Sie gerne ihren Kindern.', 1, 3);
        ...
        INSERT INTO item_werte (item, schlussel, inhalt) VALUES (3, "min_angriffsgeschwindigkeit", 0.05);
        INSERT INTO item_werte (item, schlussel, inhalt) VALUES (3, "max_angriffsgeschwindigkeit", 0.2);
    ...
    INSERT INTO item (item_kategorie, icon, name, beschreibung, item_seltenheit, reinfolge) VALUES ('1', 'WOODEN_AXE', 'Anfänger Axt II', 'Diese Axt wurde von einem \n Schreinerlehrling hergestellt. Welcher schon \n etwas Erfahrung gesammelt hat. ', 1, 4);
        ...
        INSERT INTO item_werte (item, schlussel, inhalt) VALUES (4, "min_schaden", 1);
        INSERT INTO item_werte (item, schlussel, inhalt) VALUES (4, "max_schaden", 1.5);

        INSERT INTO item_werte (item, schlussel, inhalt) VALUES (4, "min_angriffsgeschwindigkeit", 0.2);
        INSERT INTO item_werte (item, schlussel, inhalt) VALUES (4, "max_angriffsgeschwindigkeit", 0.3);
    ...
    INSERT INTO item (item_kategorie, icon, name, beschreibung, item_seltenheit, reinfolge) VALUES ('1', 'WOODEN_AXE', 'Axt des Holzfällers Lehrlings', 'Dieser klassischen Axttype wird häufig \n von Holzfällern Lehrlingen genutzt.', 1, 5);
        ...
        INSERT INTO item_werte (item, schlussel, inhalt) VALUES (5, "min_schaden", 0.5);
        INSERT INTO item_werte (item, schlussel, inhalt) VALUES (5, "max_schaden", 2);

        INSERT INTO item_werte (item, schlussel, inhalt) VALUES (5, "min_angriffsgeschwindigkeit", 0.15);
        INSERT INTO item_werte (item, schlussel, inhalt) VALUES (5, "max_angriffsgeschwindigkeit", 0.35);
    ...
    INSERT INTO item (item_kategorie, icon, name, beschreibung, item_seltenheit, reinfolge) VALUES ('1', 'STONE_AXE', 'Reststein Axt', 'Diese Axt wird aus Stein Resten gefertigt und ist \n deshalb nicht besonders robust,', 1,  6);
        ...
        INSERT INTO item_werte (item, schlussel, inhalt) VALUES (6, "min_schaden", 1);
        INSERT INTO item_werte (item, schlussel, inhalt) VALUES (6, "max_schaden", 2.2);

        INSERT INTO item_werte (item, schlussel, inhalt) VALUES (6, "min_angriffsgeschwindigkeit", 0.2);
        INSERT INTO item_werte (item, schlussel, inhalt) VALUES (6, "max_angriffsgeschwindigkeit", 0.4);
    ...
    INSERT INTO item (item_kategorie, icon, name, beschreibung, item_seltenheit, reinfolge) VALUES ('1', 'STONE_AXE', 'Granit Axt', 'Eine Axt aus Granit, fragt sich nur, ob Sie \n auch Holz hacken kann?', 1, 7);
        ...
        INSERT INTO item_werte (item, schlussel, inhalt) VALUES (7, "min_schaden", 1.5);
        INSERT INTO item_werte (item, schlussel, inhalt) VALUES (7, "max_schaden", 2.5);

        INSERT INTO item_werte (item, schlussel, inhalt) VALUES (7, "min_angriffsgeschwindigkeit", 0.2);
        INSERT INTO item_werte (item, schlussel, inhalt) VALUES (7, "max_angriffsgeschwindigkeit", 0.43);
    ...
    INSERT INTO item (item_kategorie, icon, name, beschreibung, item_seltenheit, reinfolge) VALUES ('1', 'STONE_AXE', 'Anfänger Axt III', 'Ein Lehrling im letzten Jahr hat Sie gefertigt. \n Deshalb diese Axt so perfekt aus!', 1, 8);
        ...
        INSERT INTO item_werte (item, schlussel, inhalt) VALUES (8, "min_schaden", 2);
        INSERT INTO item_werte (item, schlussel, inhalt) VALUES (8, "max_schaden", 3);

        INSERT INTO item_werte (item, schlussel, inhalt) VALUES (8, "min_angriffsgeschwindigkeit", 0.22);
        INSERT INTO item_werte (item, schlussel, inhalt) VALUES (8, "max_angriffsgeschwindigkeit", 0.42);
    ...
    INSERT INTO item (item_kategorie, icon, name, beschreibung, item_seltenheit, reinfolge) VALUES ('1', 'STONE_AXE', 'Weiße Axt', 'Diese Axt aus Stein wurde ein \n einfach weiß angemalt.', 1, 9);
        ...
        INSERT INTO item_werte (item, schlussel, inhalt) VALUES (9, "max_angriffsgeschwindigkeit", 0.45);
    ...
    INSERT INTO item (item_kategorie, icon, name, beschreibung, item_seltenheit, reinfolge) VALUES ('1', 'STONE_AXE', 'Axt des Holzfällers gesellen', 'Dieser klassischen Axttype wird \n häufig von Holzfällern gesellen genutzt.', 2, 10);
        ...
        INSERT INTO item_werte (item, schlussel, inhalt) VALUES (10, "min_schaden", 2.25);
        INSERT INTO item_werte (item, schlussel, inhalt) VALUES (10, "max_schaden", 3.5);
