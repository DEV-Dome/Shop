INSERT INTO item_kategorie (icon, name, beschreibung, reinfolge) VALUES ('NETHERITE_AXE', 'Äxte', 'Baue und erforsche die mächtigsten Äxte \n für Dungeon Stufe 1 - 4', 1);

INSERT INTO item_kategorie (icon, name, beschreibung, reinfolge) VALUES ('NETHERITE_SWORD', 'Schwerter', 'Baue und erforsche die mächtigsten Schwerter \n für Dungeon Stufe 1 - 4', 2);

INSERT INTO item_kategorie (icon, name, beschreibung, reinfolge) VALUES ('NETHERITE_HOE', 'Hacken', 'Baue und erforsche einfache Hacken \n für Dungeon Stufe 1 & 2', 3);
